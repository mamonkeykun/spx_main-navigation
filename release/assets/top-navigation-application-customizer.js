...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".breadcrumb{align-items:center;background:rgba(0,0,0,.15);display:flex;font-size:var(--bc-font-size);gap:4px;padding:6px 24px}.link{color:var(--nav-text);opacity:.7;text-decoration:none}.link:focus-visible,.link:hover{opacity:1;outline:none;text-decoration:underline}.current{font-weight:500;opacity:1}.current,.separator{color:var(--nav-text)}.separator{opacity:.4}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".wrapper{margin-bottom:16px;position:relative}.row{align-items:center;display:flex;gap:12px}.label{color:var(--nav-text,#323130);font-size:13px;min-width:160px}.swatch{border:2px solid rgba(0,0,0,.15);border-radius:50%;cursor:pointer;flex-shrink:0;height:32px;transition:border-color .15s;width:32px}.swatch:hover{border-color:rgba(0,0,0,.4)}.picker{background:#fff;border:1px solid #edebe9;border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,.2);left:0;padding:12px;position:absolute;top:44px;width:260px;z-index:2000}.canvas{border-radius:4px;cursor:crosshair;height:160px;margin-bottom:10px;position:relative;width:100%}.cursor{border:2px solid #fff;border-radius:50%;box-shadow:0 0 0 1px rgba(0,0,0,.3);height:12px;pointer-events:none;position:absolute;transform:translate(-50%,-50%);width:12px}.hueSlider{-webkit-appearance:none;background:linear-gradient(90deg,red,#ff0,#0f0,#0ff,#00f,#f0f,red);border-radius:6px;cursor:pointer;height:12px;margin-bottom:10px;width:100%}.hueSlider::-webkit-slider-thumb{-webkit-appearance:none;background:#fff;border:2px solid rgba(0,0,0,.3);border-radius:50%;cursor:pointer;height:16px;width:16px}.inputs{display:flex;gap:6px}.inputGroup{display:flex;flex:1;flex-direction:column}.inputLabel{color:#605e5c;font-size:10px;margin-bottom:2px}.inputField{border:1px solid #edebe9;border-radius:3px;font-size:12px;padding:3px 4px;text-align:center;width:100%}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".menu{animation:fadeIn .15s ease;background:#fff;border:1px solid #edebe9;border-radius:6px;box-shadow:0 4px 16px rgba(0,0,0,.15);left:0;min-width:220px;padding:6px;position:absolute;top:100%;z-index:1001}.menuHorizontal{display:grid;gap:4px;grid-template-columns:repeat(3,1fr);min-width:480px}.item{list-style:none}.link,.linkReset{border-radius:4px;color:#323130;display:flex;flex-direction:column;padding:8px 12px;text-decoration:none;transition:background .15s ease,color .15s ease}.link:focus-visible,.link:hover,.linkReset:focus-visible,.linkReset:hover{background:#f3f2f1;color:#0078d4;outline:none}@media (max-width:640px){.menuHorizontal{grid-template-columns:repeat(2,minmax(0,1fr));min-width:320px}}@keyframes fadeIn{0%{opacity:0;transform:translateY(-4px)}to{opacity:1;transform:translateY(0)}}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".picker{position:relative}.trigger{background:none;border:none;border-radius:4px;color:var(--nav-text);cursor:pointer;font-family:var(--nav-font-family);font-size:var(--nav-font-size);padding:8px 12px;transition:background .15s ease,color .15s ease}.trigger:focus-visible,.trigger:hover{background:hsla(0,0%,100%,.1);color:var(--nav-hover);outline:none}.dropdown{background:var(--nav-bg);border:1px solid hsla(0,0%,100%,.1);border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,.3);left:auto;min-width:140px;padding:8px;position:absolute;right:0;top:100%;z-index:1001}.langItem{list-style:none}.langButton{background:none;border:none;border-radius:4px;color:var(--nav-text);cursor:pointer;padding:8px 12px;text-align:left;width:100%}.langButton:focus-visible,.langButton:hover{background:hsla(0,0%,100%,.08);outline:none}.active{color:var(--nav-accent);font-weight:500}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".backdrop{background:rgba(0,0,0,.5);inset:0;position:fixed;z-index:1100}.drawer{background:var(--nav-bg);height:100vh;left:0;overflow-y:auto;padding:16px;position:fixed;top:0;transform:translateX(-100%);transition:transform .25s ease;width:min(320px,85vw);z-index:1101}.drawerOpen{transform:translateX(0)}.closeButton{background:none;border:none;color:var(--nav-text);cursor:pointer;display:flex;font-size:18px;margin-left:auto;padding:8px}.logo{height:var(--nav-logo-height);max-width:100%}.accordionToggle{align-items:center;background:none;border:none;border-bottom:1px solid hsla(0,0%,100%,.1);color:var(--nav-text);cursor:pointer;display:flex;font-size:var(--nav-font-size);font-weight:500;justify-content:space-between;padding:10px 0;text-align:left;width:100%}.accordionChevron{transition:transform .2s}.accordionChevronOpen{transform:rotate(180deg)}.accordionItems{padding:4px 0 4px 16px}.mobileLink{color:var(--nav-text);display:block;font-size:var(--nav-font-size);opacity:.85;padding:8px 0;text-decoration:none}.mobileLink:focus-visible,.mobileLink:hover{opacity:1}.divider{border:none;border-top:1px solid hsla(0,0%,100%,.1);margin:12px 0}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".wrapper{position:relative}.trigger,.wrapper{align-items:center;display:inline-flex}.trigger{background:none;border:none;border-radius:4px;color:var(--nav-text);cursor:pointer;font-size:var(--nav-font-size);padding:8px 12px;transition:background .15s ease,color .15s ease}.trigger:focus-visible,.trigger:hover,.triggerOpen{background:rgba(0,0,0,.06);color:var(--nav-hover);outline:none}.triggerOpen{color:var(--nav-hover)}.chevron{font-size:10px;margin-left:4px;opacity:.7}.closeBtn{align-items:center;background:none;border:1px solid rgba(0,0,0,.15);border-radius:50%;color:var(--nav-text,#323130);cursor:pointer;display:flex;flex-shrink:0;font-size:11px;height:20px;justify-content:center;margin-left:2px;width:20px}.closeBtn:hover{background:rgba(0,0,0,.06)}", true);
...
/***/ 5308:
/*!********************************************************************!*\
  !*** ./lib/extensions/topNavigation/components/NavItem.module.css ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".link{border-radius:4px;color:var(--nav-text);display:flex;flex-direction:column;padding:8px 12px;text-decoration:none;transition:background .15s ease,color .15s ease}.link:focus-visible,.link:hover{background:hsla(0,0%,100%,.08);color:var(--nav-hover);outline:none}.label{font-size:var(--nav-font-size);font-weight:500}.description{color:hsla(0,0%,100%,.55);font-size:11px;margin-top:2px}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".panel{background:#fff;border:1px solid #edebe9;border-radius:8px;box-shadow:0 8px 32px rgba(0,0,0,.18);font-family:Segoe UI,system-ui,sans-serif;left:0;overflow:hidden;position:absolute;top:60px;width:320px;z-index:9999}.header{align-items:center;background:#f3f2f1;border-bottom:1px solid #edebe9;display:flex;justify-content:space-between;padding:12px 16px}.title{color:#323130;font-size:14px;font-weight:600}.closeBtn{background:none;border:none;border-radius:3px;color:#605e5c;cursor:pointer;font-size:14px;padding:4px}.closeBtn:hover{background:#edebe9}.body{max-height:65vh;overflow-y:auto;padding:16px}.field{margin-bottom:14px}.fieldLabel{color:#323130;display:block;font-size:13px;margin-bottom:4px}.required{color:#c50f1f}.input,.select,.textarea{border:1px solid #edebe9;border-radius:3px;box-sizing:border-box;font-size:13px;padding:6px 8px;width:100%}.textarea{font-family:inherit;resize:vertical}.input:focus,.select:focus,.textarea:focus{border-color:#0078d4;outline:2px solid #0078d4}.checkboxRow{align-items:center;color:#323130;display:flex;font-size:13px;gap:8px;margin-bottom:14px}.errorMsg{background:#fde7e9;border-radius:4px;color:#c50f1f;font-size:13px;margin-bottom:12px;padding:8px 12px}.footer{border-top:1px solid #edebe9;padding:12px 16px}.saveBtn{background:#0078d4;border:none;border-radius:4px;color:#fff;cursor:pointer;font-size:14px;font-weight:600;padding:8px;width:100%}.saveBtn:hover:not(:disabled){background:#106ebe}.saveBtn:disabled{cursor:not-allowed;opacity:.6}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".panel{background:#fff;border:1px solid #edebe9;border-radius:8px;box-shadow:0 8px 32px rgba(0,0,0,.18);font-family:Segoe UI,system-ui,sans-serif;left:0;overflow:hidden;position:absolute;top:60px;width:340px;z-index:9999}.header{align-items:center;background:#f3f2f1;border-bottom:1px solid #edebe9;display:flex;justify-content:space-between;padding:14px 16px}.title{color:#323130;font-size:14px;font-weight:600}.closeBtn{background:none;border:none;border-radius:3px;color:#605e5c;cursor:pointer;font-size:14px;line-height:1;padding:4px}.closeBtn:hover{background:#edebe9}.body{max-height:70vh;overflow-y:auto;padding:16px}.field{margin-bottom:16px}.fieldLabel{color:#323130;display:block;font-size:13px;margin-bottom:6px}.logoArea{align-items:center;display:flex;gap:10px}.logoPreview{border-radius:3px;height:36px;object-fit:contain;width:auto}.logoInput{border:1px solid #edebe9;border-radius:3px;flex:1;font-size:13px;padding:6px 8px}.toggleRow{align-items:center;display:flex;justify-content:space-between;margin-bottom:16px}.toggleLabel{color:#323130;font-size:13px}.toggle{background:#c8c6c4;border:none;border-radius:11px;cursor:pointer;height:22px;padding:0;position:relative;transition:background .2s;width:40px}.toggleOn{background:#0078d4}.toggleThumb{background:#fff;border-radius:50%;height:18px;left:2px;position:absolute;top:2px;transition:left .2s;width:18px}.toggleOn .toggleThumb{left:20px}.footer{border-top:1px solid #edebe9;padding:12px 16px}.saveBtn{background:#0078d4;border:none;border-radius:4px;color:#fff;cursor:pointer;font-size:14px;font-weight:600;padding:8px;transition:background .15s;width:100%}.saveBtn:hover:not(:disabled){background:#106ebe}.saveBtn:disabled{cursor:not-allowed;opacity:.6}", true);
...
/***/ 3472:
/*!***********************************************************************!*\
  !*** ./lib/extensions/topNavigation/components/SizeSlider.module.css ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".wrapper{align-items:center;display:flex;gap:12px;margin-bottom:16px}.label{color:#323130;flex-shrink:0;font-size:13px;min-width:160px}.slider{accent-color:#0078d4;cursor:pointer;flex:1}.value{color:#323130;font-size:13px;font-weight:500;min-width:32px;text-align:right}", true);
...
_node_modules_microsoft_sp_css_loader_node_modules_microsoft_load_themed_styles_lib_es6_index_js__WEBPACK_IMPORTED_MODULE_0__.loadStyles(".nav{background:var(--nav-bg,#fff);box-shadow:0 1px 4px rgba(0,0,0,.12);height:56px;left:0;padding:0 16px;position:fixed;right:0;top:0;z-index:9999}.adminArea,.nav{align-items:center;display:flex;gap:8px}.adminArea{flex-shrink:0}.gearBtn{background:none;border:none;border-radius:4px;color:var(--nav-text,#323130);cursor:pointer;font-size:18px;line-height:1;padding:6px;transition:background .15s}.gearBtn:hover{background:rgba(0,0,0,.06)}.editBtn{background:#0078d4;border:none;border-radius:4px;color:#fff;cursor:pointer;font-size:13px;font-weight:600;padding:6px 14px;transition:background .15s;white-space:nowrap}.editBtn:hover{background:#106ebe}.logo{flex-shrink:0;height:var(--nav-logo-height,40px);object-fit:contain;width:auto}.folderRow{align-items:center;display:flex;flex:1;gap:2px}.hamburger{background:none;border:none;color:var(--nav-text,#323130);cursor:pointer;display:none;font-size:20px;margin-left:auto;padding:6px}.skeleton{animation:shimmer 1.5s infinite;background:#f3f2f1;height:56px;left:0;position:fixed;right:0;top:0;z-index:9999}@keyframes shimmer{0%{opacity:.6}50%{opacity:1}to{opacity:.6}}@media (max-width:768px){.folderRow{display:none}.hamburger{display:block}}", true);
    ...
    constructor() {
        ...
        this._renderPlaceholders = () => {
            ...
            if (!this._headerPlaceholder) {
                this._headerPlaceholder = this.context.placeholderProvider.tryCreateContent(sp_application_base_1.PlaceholderName.Top, { onDispose: this._onDispose });
            }
            if (!((_a = this._headerPlaceholder) === null || _a === void 0 ? void 0 : _a.domElement)) {
                return;
            }
            const element = React.createElement(TopNav_1.TopNav, { context: this.context });
...
exports["default"] = TopNavigationApplicationCustomizer;
 ...
 */
function findCurrentItem(items, currentOrigin, currentPath) {
    var _a;
    const matchingItems = items
        .filter((item) => item.url)
        .filter((item) => currentPath.startsWith(new URL(item.url, currentOrigin).pathname.toLowerCase()))
        .sort((left, right) => right.url.length - left.url.length);
    return (_a = matchingItems[0]) !== null && _a !== void 0 ? _a : null;
}
/**
 * Renders the page breadcrumb derived from the current URL.
 */
function Breadcrumb({ items, fontSize }) {
    const folders = (0, NavStructureContext_1.useNavStructure)();
    ...
    const segments = React.useMemo(() => {
        ...
        const parentFolder = folders.find((folder) => folder.folderPath === currentItem.parentFolderPath);
        const nextSegments = [{ href: currentOrigin, label: 'ホーム' }];
        if (parentFolder) {
    ...
    return (React.createElement("div", { className: Breadcrumb_module_css_1.default.breadcrumb, style: { '--bc-font-size': `${fontSize}px` }, "aria-label": "\u30D1\u30F3\u304F\u305A\u30EA\u30B9\u30C8" }, segments.map((segment, index) => {
        const isLast = index === segments.length - 1;
        return (React.createElement(React.Fragment, { key: `${segment.label}-${index}` },
            segment.href && !isLast ? (React.createElement("a", { className: Breadcrumb_module_css_1.default.link, href: segment.href, "aria-label": segment.label }, segment.label)) : (React.createElement("span", { className: Breadcrumb_module_css_1.default.current, "aria-current": isLast ? 'page' : undefined }, segment.label)),
            !isLast ? React.createElement("span", { className: Breadcrumb_module_css_1.default.separator }, "\u203A") : null));
    })));
}
...
const ColorPicker = ({ value, onChange, label }) => {
    ...
    const [localHsv, setLocalHsv] = (0, react_1.useState)(() => (0, colorUtils_1.rgbToHsv)((0, colorUtils_1.hexToRgb)(value)));
    const [hexInput, setHexInput] = (0, react_1.useState)(value.replace('#', ''));
    const wrapperRef = (0, react_1.useRef)(null);
    React.useEffect(() => {
        setLocalHsv((0, colorUtils_1.rgbToHsv)((0, colorUtils_1.hexToRgb)(value)));
    ...
    const applyHsv = (0, react_1.useCallback)((nextHsv) => {
        setLocalHsv(nextHsv);
        const nextRgb = (0, colorUtils_1.hsvToRgb)(nextHsv);
        const nextHex = (0, colorUtils_1.rgbToHex)(nextRgb.r, nextRgb.g, nextRgb.b);
        setHexInput(nextHex.replace('#', ''));
        onChange(nextHex);
    }, [onChange]);
    const currentRgb = (0, colorUtils_1.hsvToRgb)(localHsv);
    const currentHex = (0, colorUtils_1.rgbToHex)(currentRgb.r, currentRgb.g, currentRgb.b);
    return (React.createElement("div", { className: ColorPicker_module_css_1.default.wrapper, ref: wrapperRef },
        React.createElement("div", { className: ColorPicker_module_css_1.default.row },
            React.createElement("span", { className: ColorPicker_module_css_1.default.label }, label),
            React.createElement("button", { type: "button", className: ColorPicker_module_css_1.default.swatch, style: { background: currentHex }, onClick: () => setOpen((current) => !current), "aria-label": `${label}を選択`, "aria-expanded": open })),
        open ? (React.createElement(ColorPickerPanel_1.ColorPickerPanel, { hsv: localHsv, rgb: currentRgb, hexInput: hexInput, label: label, onCanvasClick: (event) => {
                ...
                if (nextValue.length === 6) {
                    applyHsv((0, colorUtils_1.rgbToHsv)((0, colorUtils_1.hexToRgb)(`#${nextValue}`)));
                }
                ...
                applyHsv((0, colorUtils_1.rgbToHsv)(nextRgb));
            } })) : null));
};
 ...
 * カラーピッカーのパネル本体。
 */
const ColorPickerPanel = ({ hsv, rgb, hexInput, onCanvasClick, onHueChange, onHexInput, onChannelChange, label, }) => {
    const hueRgb = (0, colorUtils_1.hsvToRgb)({ h: hsv.h, s: 1, v: 1 });
    const hueColor = (0, colorUtils_1.rgbToHex)(hueRgb.r, hueRgb.g, hueRgb.b);
    return (React.createElement("div", { className: ColorPicker_module_css_1.default.picker, role: "dialog", "aria-label": `${label}カラーピッカー` },
        React.createElement("div", { className: ColorPicker_module_css_1.default.canvas, onClick: onCanvasClick, style: {
                background: `linear-gradient(to bottom, #fff, #000), linear-gradient(to right, #fff, ${hueColor})`,
                backgroundBlendMode: 'multiply, normal',
            } },
            React.createElement("div", { className: ColorPicker_module_css_1.default.cursor, style: {
                    left: `${hsv.s * 100}%`,
                    top: `${(1 - hsv.v) * 100}%`,
                } })),
        React.createElement("input", { type: "range", min: 0, max: 360, value: Math.round(hsv.h * 360), onChange: onHueChange, className: ColorPicker_module_css_1.default.hueSlider, "aria-label": "\u8272\u76F8" }),
        React.createElement("div", { className: ColorPicker_module_css_1.default.inputs },
            React.createElement("div", { className: ColorPicker_module_css_1.default.inputGroup },
                React.createElement("label", { className: ColorPicker_module_css_1.default.inputLabel }, "16\u9032\u6570"),
                React.createElement("input", { className: ColorPicker_module_css_1.default.inputField, value: hexInput, onChange: onHexInput, maxLength: 6, "aria-label": "16\u9032\u6570\u30AB\u30E9\u30FC\u30B3\u30FC\u30C9" })),
            CHANNELS.map((channel) => (React.createElement("div", { key: channel, className: ColorPicker_module_css_1.default.inputGroup },
                React.createElement("label", { className: ColorPicker_module_css_1.default.inputLabel }, CHANNEL_LABELS[channel]),
                React.createElement("input", { className: ColorPicker_module_css_1.default.inputField, value: Math.round(rgb[channel]), onChange: (event) => onChannelChange(channel, Number(event.target.value)), type: "number", min: 0, max: 255, "aria-label": `${CHANNEL_LABELS[channel]}チャンネル` })))))));
};
...
/***/ 6558:
/*!*****************************************************************!*\
  !*** ./lib/extensions/topNavigation/components/DropdownMenu.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 */
function moveFocus(itemRefs, activeIndex, direction) {
    var _a;
 ...
 */
function DropdownMenu({ items, layout, isOpen, anchorRef, ariaLabel, onRequestClose, }) {
    var _a, _b;
    ...
    const menuClassName = layout === 'horizontal' ? `${DropdownMenu_module_css_1.default.menu} ${DropdownMenu_module_css_1.default.menuHorizontal}` : DropdownMenu_module_css_1.default.menu;
    return (React.createElement("ul", { className: menuClassName, role: "menu", "aria-label": (_b = ariaLabel !== null && ariaLabel !== void 0 ? ariaLabel : (_a = anchorRef.current) === null || _a === void 0 ? void 0 : _a.textContent) !== null && _b !== void 0 ? _b : 'ナビゲーションメニュー', onKeyDown: handleKeyDown }, items.map((item, index) => (React.createElement("li", { key: item.id, className: DropdownMenu_module_css_1.default.item, role: "none" },
        React.createElement(NavItem_1.default, { item: item, className: DropdownMenu_module_css_1.default.linkReset, onActivate: onRequestClose, ref: (element) => {
 ...
 */
function moveLanguageFocus(itemRefs, activeIndex, direction) {
    var _a;
    const nextIndex = (activeIndex + direction + itemRefs.current.length) % itemRefs.current.length;
    (_a = itemRefs.current[nextIndex]) === null || _a === void 0 ? void 0 : _a.focus();
}
 ...
 */
function LanguagePicker({ languages, currentLanguage, onLanguageChange, }) {
    var _a, _b;
    const wrapperRef = React.useRef(null);
    const triggerRef = React.useRef(null);
    const itemRefs = React.useRef([]);
    const [isOpen, setIsOpen] = React.useState(false);
    const currentLanguageLabel = (_b = (_a = languages.find((language) => language.code === currentLanguage)) === null || _a === void 0 ? void 0 : _a.label) !== null && _b !== void 0 ? _b : currentLanguage;
    React.useEffect(() => {
        const handler = (e) => {
    ...
    return (React.createElement("div", { ref: wrapperRef, className: LanguagePicker_module_css_1.default.picker },
        React.createElement("button", { ref: triggerRef, type: "button", className: LanguagePicker_module_css_1.default.trigger, "aria-label": "\u8A00\u8A9E\u3092\u9078\u629E", "aria-expanded": isOpen, "aria-haspopup": "menu", onClick: () => setIsOpen((current) => !current), onKeyDown: (event) => {
                if (event.key === 'Escape') {
                    setIsOpen(false);
                }
            } }, currentLanguageLabel.slice(0, 2).toUpperCase()),
        isOpen ? (React.createElement("ul", { className: LanguagePicker_module_css_1.default.dropdown, role: "menu", "aria-label": "\u8A00\u8A9E\u4E00\u89A7", onKeyDown: handleKeyDown }, languages.map((language, index) => {
            const isActive = language.code === currentLanguage;
            const buttonClassName = isActive ? `${LanguagePicker_module_css_1.default.langButton} ${LanguagePicker_module_css_1.default.active}` : LanguagePicker_module_css_1.default.langButton;
            return (React.createElement("li", { key: language.code, className: LanguagePicker_module_css_1.default.langItem, role: "none" },
                React.createElement("button", { ref: (element) => {
                        itemRefs.current[index] = element;
                    }, type: "button", className: buttonClassName, role: "menuitem", "aria-label": language.label, onClick: () => {
...
/***/ 7827:
/*!*****************************************************************!*\
  !*** ./lib/extensions/topNavigation/components/MobileDrawer.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 */
function MobileDrawer({ isOpen, onClose, folders, config, getItemsForFolder, getTopLevelItems, }) {
    ...
    React.useEffect(() => {
        ...
        const handleKeyDown = (event) => {
            ...
            const focusable = (_a = drawerRef.current) === null || _a === void 0 ? void 0 : _a.querySelectorAll('a, button, [tabindex]:not([tabindex="-1"])');
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: MobileDrawer_module_css_1.default.backdrop, onClick: onClose, "aria-hidden": "true" }),
        React.createElement("div", { ref: drawerRef, className: `${MobileDrawer_module_css_1.default.drawer} ${MobileDrawer_module_css_1.default.drawerOpen}`, role: "dialog", "aria-modal": "true", "aria-label": "\u30E2\u30D0\u30A4\u30EB\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3" },
            React.createElement("button", { type: "button", className: MobileDrawer_module_css_1.default.closeButton, onClick: onClose, "aria-label": "\u9589\u3058\u308B" }, "X \u9589\u3058\u308B"),
            config.logoUrl ? React.createElement("img", { className: MobileDrawer_module_css_1.default.logo, src: config.logoUrl, alt: "", "aria-hidden": "true" }) : null,
            React.createElement("hr", { className: MobileDrawer_module_css_1.default.divider }),
            topLevelItems.map((item) => (React.createElement(NavItem_1.default, { key: item.id, item: item, className: MobileDrawer_module_css_1.default.mobileLink, onActivate: onClose }))),
            topLevelItems.length > 0 ? React.createElement("hr", { className: MobileDrawer_module_css_1.default.divider }) : null,
            folders.map((folder) => {
                var _a;
                const isExpanded = (_a = openFolders[folder.id]) !== null && _a !== void 0 ? _a : false;
                const folderItems = getItemsForFolder(folder);
                return (React.createElement("div", { key: folder.id },
                    React.createElement("button", { type: "button", className: MobileDrawer_module_css_1.default.accordionToggle, "aria-expanded": isExpanded, onClick: () => setOpenFolders((current) => ({ ...current, [folder.id]: !isExpanded })) },
                        React.createElement("span", null, folder.label),
                        React.createElement("span", { className: isExpanded
                                ? `${MobileDrawer_module_css_1.default.accordionChevron} ${MobileDrawer_module_css_1.default.accordionChevronOpen}`
                                : MobileDrawer_module_css_1.default.accordionChevron }, "\u25BE")),
                    isExpanded ? (React.createElement("div", { className: MobileDrawer_module_css_1.default.accordionItems }, folderItems.map((item) => (React.createElement(NavItem_1.default, { key: item.id, item: item, className: MobileDrawer_module_css_1.default.mobileLink, onActivate: onClose }))))) : null));
            }),
            config.showLanguagePicker ? (React.createElement(React.Fragment, null,
                React.createElement("hr", { className: MobileDrawer_module_css_1.default.divider }),
                React.createElement(LanguagePicker_1.default, { languages: languageOptions, currentLanguage: "ja", onLanguageChange: (code) => {
 ...
 */
function NavFolder({ folder, items, dropdownLayout, }) {
    const wrapperRef = React.useRef(null);
    const triggerRef = React.useRef(null);
    const closeTimerRef = React.useRef(undefined);
    const [isOpen, setIsOpen] = React.useState(false);
    ...
    const triggerClassName = isOpen ? `${NavFolder_module_css_1.default.trigger} ${NavFolder_module_css_1.default.triggerOpen}` : NavFolder_module_css_1.default.trigger;
    const hasLandingPage = typeof folder.url === 'string' && folder.url.trim() !== '';
    return (React.createElement("div", { ref: wrapperRef, className: NavFolder_module_css_1.default.wrapper, onMouseEnter: handleOpen, onMouseLeave: handleClose },
        React.createElement("button", { ref: triggerRef, type: "button", className: triggerClassName, "aria-expanded": hasItems ? isOpen : undefined, "aria-haspopup": hasItems ? 'menu' : undefined, "aria-label": folder.label, onClick: () => {
                if (hasItems) {
                    setIsOpen((current) => !current);
                }
                else if (hasLandingPage) {
                    window.location.assign(folder.url);
                }
            }, onKeyDown: handleTriggerKeyDown },
            folder.label,
            hasItems && !isOpen ? React.createElement("span", { className: NavFolder_module_css_1.default.chevron, "aria-hidden": "true" }, "\u2228") : null),
        isOpen && hasItems ? (React.createElement("button", { type: "button", className: NavFolder_module_css_1.default.closeBtn, onClick: () => setIsOpen(false), "aria-label": `${folder.label}を閉じる` }, "\u2715")) : null,
        React.createElement(DropdownMenu_1.default, { items: items, layout: dropdownLayout, isOpen: isOpen, anchorRef: triggerRef, ariaLabel: folder.label, onRequestClose: () => setIsOpen(false) })));
}
...
/***/ 8552:
/*!************************************************************!*\
  !*** ./lib/extensions/topNavigation/components/NavItem.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 */
const NavItem = React.forwardRef(function NavItem({ item, className, onActivate, role, tabIndex }, ref) {
    const linkClassName = className ? `${NavItem_module_css_1.default.link} ${className}` : NavItem_module_css_1.default.link;
    return (React.createElement("a", { ref: ref, className: linkClassName, href: item.url, target: item.openInNewTab ? '_blank' : undefined, rel: item.openInNewTab ? 'noreferrer' : undefined, "aria-label": item.label, role: role, tabIndex: tabIndex, onClick: onActivate },
        React.createElement("span", { className: NavItem_module_css_1.default.label }, item.label),
        item.description ? React.createElement("span", { className: NavItem_module_css_1.default.description }, item.description) : null));
});
...
function toFormValues(itemData) {
    ...
    return [
        ...
        { FieldName: 'NavDescription', FieldValue: (_a = itemData.NavDescription) !== null && _a !== void 0 ? _a : '' },
        { FieldName: 'NavOpenInNewTab', FieldValue: itemData.NavOpenInNewTab ? '1' : '0' },
        { FieldName: 'NavOrder', FieldValue: String(itemData.NavOrder) },
    ];
}
const NavItemEditor = ({ context, folders, items, onClose, onSaved, }) => {
    const [selectedLink, setSelectedLink] = (0, react_1.useState)('新規');
    const [title, setTitle] = (0, react_1.useState)('');
    const [description, setDescription] = (0, react_1.useState)('');
    const [url, setUrl] = (0, react_1.useState)('');
    const [openInNewWindow, setOpenInNewWindow] = (0, react_1.useState)(false);
    const [parentFolderId, setParentFolderId] = (0, react_1.useState)('');
    ...
    (0, react_1.useEffect)(() => {
        ...
        setDescription((_a = selectedLink.description) !== null && _a !== void 0 ? _a : '');
        setUrl(selectedLink.url);
        setOpenInNewWindow(selectedLink.openInNewTab);
        setSortOrder(selectedLink.order);
        const matchedFolder = folders.find((folder) => folder.folderPath === selectedLink.parentFolderPath);
        setParentFolderId((_b = matchedFolder === null || matchedFolder === void 0 ? void 0 : matchedFolder.id) !== null && _b !== void 0 ? _b : '');
    }, [folders, selectedLink]);
    const handleSelectLinkChange = (0, react_1.useCallback)((value) => {
        if (value === '新規') {
            setSelectedLink('新規');
            return;
        }
    ...
    const handleSave = (0, react_1.useCallback)(async () => {
        ...
        try {
            ...
            const targetFolderPath = (_a = parentFolder === null || parentFolder === void 0 ? void 0 : parentFolder.folderPath) !== null && _a !== void 0 ? _a : rootFolderPath;
            const itemData = {
                Title: title.trim(),
                NavUrl: url.trim(),
    ...
    return (React.createElement("div", { className: NavItemEditor_module_css_1.default.panel, role: "dialog", "aria-label": "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u3092\u8FFD\u52A0\u30FB\u7DE8\u96C6" },
        React.createElement("div", { className: NavItemEditor_module_css_1.default.header },
            React.createElement("span", { className: NavItemEditor_module_css_1.default.title }, "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u3092\u8FFD\u52A0\u30FB\u7DE8\u96C6"),
            React.createElement("button", { className: NavItemEditor_module_css_1.default.closeBtn, onClick: onClose, "aria-label": "\u9589\u3058\u308B", type: "button" }, "\u2715")),
        React.createElement(NavItemEditorForm_1.NavItemEditorForm, { selectedLinkValue: selectedLinkValue, allItems: items, title: title, description: description, url: url, openInNewWindow: openInNewWindow, parentFolderId: parentFolderId, sortOrder: sortOrder, folders: folders, error: error, onSelectLinkChange: handleSelectLinkChange, onTitleChange: setTitle, onDescriptionChange: setDescription, onUrlChange: setUrl, onOpenInNewWindowChange: setOpenInNewWindow, onParentFolderIdChange: setParentFolderId, onSortOrderChange: setSortOrder }),
        React.createElement("div", { className: NavItemEditor_module_css_1.default.footer },
            React.createElement("button", { type: "button", className: NavItemEditor_module_css_1.default.saveBtn, onClick: handleSave, disabled: saving, "aria-label": "\u4FDD\u5B58" }, saving ? '保存中...' : '保存'))));
};
exports.NavItemEditor = NavItemEditor;
 ...
 * ナビアイテム編集フォーム。
 */
const NavItemEditorForm = ({ selectedLinkValue, allItems, title, description, url, openInNewWindow, parentFolderId, sortOrder, folders, error, onSelectLinkChange, onTitleChange, onDescriptionChange, onUrlChange, onOpenInNewWindowChange, onParentFolderIdChange, onSortOrderChange, }) => (React.createElement("div", { className: NavItemEditor_module_css_1.default.body },
    error ? React.createElement("div", { className: NavItemEditor_module_css_1.default.errorMsg, role: "alert" }, error) : null,
    React.createElement("div", { className: NavItemEditor_module_css_1.default.field },
        React.createElement("label", { className: NavItemEditor_module_css_1.default.fieldLabel }, "\u30EA\u30F3\u30AF\u3092\u9078\u629E"),
        React.createElement("select", { className: NavItemEditor_module_css_1.default.select, value: selectedLinkValue, onChange: (event) => onSelectLinkChange(event.target.value), "aria-label": "\u30EA\u30F3\u30AF\u3092\u9078\u629E" },
            React.createElement("option", { value: "\u65B0\u898F" }, "\u65B0\u898F"),
            allItems.map((item) => (React.createElement("option", { key: item.id, value: item.id }, item.label))))),
    React.createElement("div", { className: NavItemEditor_module_css_1.default.field },
        React.createElement("label", { className: NavItemEditor_module_css_1.default.fieldLabel },
            "\u30BF\u30A4\u30C8\u30EB ",
            React.createElement("span", { className: NavItemEditor_module_css_1.default.required }, "*")),
        React.createElement("input", { type: "text", className: NavItemEditor_module_css_1.default.input, value: title, onChange: (event) => onTitleChange(event.target.value), "aria-label": "\u30BF\u30A4\u30C8\u30EB\uFF08\u5FC5\u9808\uFF09", "aria-required": "true" })),
    React.createElement("div", { className: NavItemEditor_module_css_1.default.field },
        React.createElement("label", { className: NavItemEditor_module_css_1.default.fieldLabel }, "\u8AAC\u660E"),
        React.createElement("textarea", { className: NavItemEditor_module_css_1.default.textarea, value: description, onChange: (event) => onDescriptionChange(event.target.value), rows: 3, "aria-label": "\u8AAC\u660E" })),
    React.createElement("div", { className: NavItemEditor_module_css_1.default.field },
        React.createElement("label", { className: NavItemEditor_module_css_1.default.fieldLabel },
            "URL ",
            React.createElement("span", { className: NavItemEditor_module_css_1.default.required }, "*")),
        React.createElement("input", { type: "url", className: NavItemEditor_module_css_1.default.input, value: url, onChange: (event) => onUrlChange(event.target.value), "aria-label": "URL\uFF08\u5FC5\u9808\uFF09", "aria-required": "true" })),
    React.createElement("div", { className: NavItemEditor_module_css_1.default.checkboxRow },
        React.createElement("input", { type: "checkbox", id: "openInNewWindow", checked: openInNewWindow, onChange: (event) => onOpenInNewWindowChange(event.target.checked) }),
        React.createElement("label", { htmlFor: "openInNewWindow" }, "\u65B0\u3057\u3044\u30A6\u30A3\u30F3\u30C9\u30A6\u3067\u958B\u304F")),
    React.createElement("div", { className: NavItemEditor_module_css_1.default.field },
        React.createElement("label", { className: NavItemEditor_module_css_1.default.fieldLabel }, "\u89AA\u30D5\u30A9\u30EB\u30C0"),
        React.createElement("select", { className: NavItemEditor_module_css_1.default.select, value: parentFolderId, onChange: (event) => onParentFolderIdChange(event.target.value), "aria-label": "\u89AA\u30D5\u30A9\u30EB\u30C0" },
            React.createElement("option", { value: "" }, "\uFF08\u306A\u3057 - \u30C8\u30C3\u30D7\u30EC\u30D9\u30EB\uFF09"),
            folders.map((folder) => (React.createElement("option", { key: folder.id, value: folder.id }, folder.label))))),
    React.createElement("div", { className: NavItemEditor_module_css_1.default.field },
        React.createElement("label", { className: NavItemEditor_module_css_1.default.fieldLabel }, "\u4E26\u3073\u9806\uFF08\u6570\u5024\uFF09"),
        React.createElement("input", { type: "number", className: NavItemEditor_module_css_1.default.input, value: sortOrder, onChange: (event) => onSortOrderChange(Number(event.target.value)), "aria-label": "\u4E26\u3073\u9806" }))));
exports.NavItemEditorForm = NavItemEditorForm;
...
function useNavStructure() {
    return (0, react_1.useContext)(NavStructureContext);
}
exports.useNavStructure = useNavStructure;
exports["default"] = NavStructureContext;
...
const SettingsPanel = ({ config, onSave, onClose, saving, }) => {
    ...
    const [logoPreview, setLogoPreview] = (0, react_1.useState)((_a = config.logoUrl) !== null && _a !== void 0 ? _a : '');
    ...
    return (React.createElement("div", { className: SettingsPanel_module_css_1.default.panel, role: "dialog", "aria-label": "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u8A2D\u5B9A" },
        React.createElement("div", { className: SettingsPanel_module_css_1.default.header },
            React.createElement("span", { className: SettingsPanel_module_css_1.default.title }, "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u8A2D\u5B9A"),
            React.createElement("button", { className: SettingsPanel_module_css_1.default.closeBtn, onClick: onClose, "aria-label": "\u9589\u3058\u308B", type: "button" }, "\u2715")),
        React.createElement("div", { className: SettingsPanel_module_css_1.default.body },
            React.createElement("div", { className: SettingsPanel_module_css_1.default.field },
                React.createElement("label", { className: SettingsPanel_module_css_1.default.fieldLabel }, "\u30ED\u30B4"),
                React.createElement("div", { className: SettingsPanel_module_css_1.default.logoArea },
                    logoPreview ? (React.createElement("img", { src: logoPreview, alt: "\u30ED\u30B4\u30D7\u30EC\u30D3\u30E5\u30FC", className: SettingsPanel_module_css_1.default.logoPreview })) : null,
                    React.createElement("input", { type: "text", className: SettingsPanel_module_css_1.default.logoInput, value: (_b = draft.logoUrl) !== null && _b !== void 0 ? _b : '', placeholder: "\u30ED\u30B4\u753B\u50CF\u306EURL\u3092\u5165\u529B", "aria-label": "\u30ED\u30B4\u753B\u50CFURL", onChange: (event) => {
                            update('logoUrl', event.target.value);
                            setLogoPreview(event.target.value);
                        } }))),
            React.createElement(ColorPicker_1.ColorPicker, { label: "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u80CC\u666F\u8272", value: draft.backgroundColor, onChange: (value) => update('backgroundColor', value) }),
            React.createElement(ColorPicker_1.ColorPicker, { label: "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u30EA\u30F3\u30AF\u306E\u8272", value: draft.textColor, onChange: (value) => update('textColor', value) }),
            React.createElement(ColorPicker_1.ColorPicker, { label: "\u30DB\u30D0\u30FC\u6642\u306E\u8272", value: draft.hoverColor, onChange: (value) => update('hoverColor', value) }),
            React.createElement(SizeSlider_1.SizeSlider, { label: "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u30D5\u30A9\u30F3\u30C8\u30B5\u30A4\u30BA", value: draft.fontSize, min: 10, max: 32, onChange: (value) => update('fontSize', value) }),
            React.createElement(SizeSlider_1.SizeSlider, { label: "\u30ED\u30B4\u753B\u50CF\u30B5\u30A4\u30BA", value: draft.logoSize, min: 20, max: 80, onChange: (value) => update('logoSize', value) }),
            React.createElement("div", { className: SettingsPanel_module_css_1.default.toggleRow },
                React.createElement("span", { className: SettingsPanel_module_css_1.default.toggleLabel }, "SharePoint\u30D8\u30C3\u30C0\u30FC\u30CA\u30D3\u3092\u975E\u8868\u793A"),
                React.createElement("button", { type: "button", role: "switch", "aria-checked": draft.hideSharePointNav, className: `${SettingsPanel_module_css_1.default.toggle} ${draft.hideSharePointNav ? SettingsPanel_module_css_1.default.toggleOn : ''}`, onClick: () => update('hideSharePointNav', !draft.hideSharePointNav), "aria-label": "SharePoint\u30D8\u30C3\u30C0\u30FC\u30CA\u30D3\u3092\u975E\u8868\u793A" },
                    React.createElement("span", { className: SettingsPanel_module_css_1.default.toggleThumb })))),
        React.createElement("div", { className: SettingsPanel_module_css_1.default.footer },
            React.createElement("button", { type: "button", className: SettingsPanel_module_css_1.default.saveBtn, onClick: handleSave, disabled: saving, "aria-label": "\u8A2D\u5B9A\u3092\u4FDD\u5B58" }, saving ? '保存中...' : '保存'))));
};
...
const SizeSlider = ({ label, value, min, max, onChange, }) => (React.createElement("div", { className: SizeSlider_module_css_1.default.wrapper },
    ...
    React.createElement("input", { type: "range", min: min, max: max, value: value, onChange: (event) => onChange(Number(event.target.value)), className: SizeSlider_module_css_1.default.slider, "aria-label": label }),
    React.createElement("span", { className: SizeSlider_module_css_1.default.value }, value)));
 ...
 */
function TopNav({ context }) {
    var _a;
    const { config, saveConfig, loading: configLoading, error: configError, } = (0, useNavConfig_1.useNavConfig)(context);
    const { folders, items, loading: navLoading, error: navError, reload, getItemsForFolder, getTopLevelItems, } = (0, useNavData_1.useNavData)(context, config.sourceUrl);
    const [drawerOpen, setDrawerOpen] = React.useState(false);
    const [settingsOpen, setSettingsOpen] = React.useState(false);
    const [editorOpen, setEditorOpen] = React.useState(false);
    const [saving, setSaving] = React.useState(false);
    const isAdmin = ((_a = context.pageContext.legacyPageContext) === null || _a === void 0 ? void 0 : _a.isSiteAdmin) === true;
    const topLevelItems = getTopLevelItems();
    const languageOptions = React.useMemo(() => [{ code: 'ja', label: '日本語' }], []);
    React.useEffect(() => {
        if (!config.hideSharePointNav) {
            (0, hideSpNav_1.removeHideSpNav)();
            return;
        }
        (0, hideSpNav_1.injectHideSpNav)();
        return () => {
            (0, hideSpNav_1.removeHideSpNav)();
        };
    }, [config.hideSharePointNav]);
    const handleSaveConfig = React.useCallback(async (patch) => {
        setSaving(true);
        try {
    ...
    if (configLoading || navLoading) {
        return React.createElement("div", { className: TopNav_module_css_1.default.skeleton, "aria-label": "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u8AAD\u307F\u8FBC\u307F\u4E2D" });
    }
    if (configError || navError) {
        return null;
    }
    return (React.createElement(NavStructureContext_1.default.Provider, { value: folders },
        React.createElement(React.Fragment, null,
            React.createElement("nav", { className: TopNav_module_css_1.default.nav, "aria-label": "\u30E1\u30A4\u30F3\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3", style: {
                ...
                isAdmin ? (React.createElement("div", { className: TopNav_module_css_1.default.adminArea },
                    React.createElement("button", { type: "button", className: TopNav_module_css_1.default.gearBtn, onClick: () => {
                            setSettingsOpen((open) => !open);
                            setEditorOpen(false);
                        }, "aria-label": "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u8A2D\u5B9A", "aria-expanded": settingsOpen, "aria-haspopup": "dialog" }, "\u2699"),
                    React.createElement("button", { type: "button", className: TopNav_module_css_1.default.editBtn, onClick: () => {
                            setEditorOpen((open) => !open);
                            setSettingsOpen(false);
                        }, "aria-label": "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u3092\u8FFD\u52A0\u30FB\u7DE8\u96C6", "aria-expanded": editorOpen, "aria-haspopup": "dialog" }, "\u30CA\u30D3\u30B2\u30FC\u30B7\u30E7\u30F3\u3092\u8FFD\u52A0\u30FB\u7DE8\u96C6"))) : null,
                config.logoUrl ? React.createElement("img", { className: TopNav_module_css_1.default.logo, src: config.logoUrl, alt: "\u30ED\u30B4" }) : null,
                React.createElement("div", { className: TopNav_module_css_1.default.folderRow },
                    folders.map((folder) => (React.createElement(NavFolder_1.default, { key: folder.id, folder: folder, items: getItemsForFolder(folder), dropdownLayout: config.dropdownLayout }))),
                    topLevelItems.map((item) => (React.createElement(NavItem_1.default, { key: item.id, item: item })))),
                React.createElement("button", { type: "button", className: TopNav_module_css_1.default.hamburger, "aria-label": "\u30E1\u30CB\u30E5\u30FC\u3092\u958B\u304F", "aria-expanded": drawerOpen, onClick: () => setDrawerOpen(true) }, "\u2630"),
                config.showLanguagePicker ? (React.createElement(LanguagePicker_1.default, { languages: languageOptions, currentLanguage: "ja", onLanguageChange: (code) => {
                        const nextUrl = new URL(window.location.href);
                        nextUrl.searchParams.set('lang', code);
                        window.location.assign(nextUrl.toString());
                    } })) : null,
                isAdmin && settingsOpen ? (React.createElement(SettingsPanel_1.SettingsPanel, { config: config, onSave: handleSaveConfig, onClose: () => setSettingsOpen(false), saving: saving })) : null,
                isAdmin && editorOpen ? (React.createElement(NavItemEditor_1.NavItemEditor, { context: context, folders: folders, items: items, onClose: () => setEditorOpen(false), onSaved: reload })) : null),
            React.createElement(MobileDrawer_1.default, { isOpen: drawerOpen, onClose: () => setDrawerOpen(false), folders: folders, config: config, getItemsForFolder: getItemsForFolder, getTopLevelItems: getTopLevelItems }),
            config.showBreadcrumb ? React.createElement(Breadcrumb_1.default, { items: items, fontSize: config.breadcrumbFontSize }) : null)));
}
...
function useNavConfig(context) {
        ...
        sp.web.allProperties()
            ...
            if (typeof raw === 'string') {
                try {
                    ...
                    setConfig({ ...navTypes_1.DEFAULT_NAV_CONFIG, ...parsed });
                }
                catch {
                    setConfig(navTypes_1.DEFAULT_NAV_CONFIG);
                }
            }
            setLoading(false);
        })
    ...
    const saveConfig = (0, react_1.useCallback)(async (patch) => {
        const next = {
            ...config,
            ...patch,
        };
...
function useNavData(context, sourceUrl) {
    ...
    const sp = (0, react_1.useMemo)(() => {
        const targetUrl = sourceUrl && sourceUrl.trim() !== ''
            ? sourceUrl.trim()
            : context.pageContext.web.absoluteUrl;
        return (0, sp_1.spfi)(targetUrl).using((0, sp_1.SPFx)(context));
    }, [sourceUrl, context]);
    const reload = (0, react_1.useCallback)(() => {
        setReloadCounter((count) => count + 1);
    }, []);
    const getItemsForFolder = (0, react_1.useCallback)((folder) => {
    ...
    const getTopLevelItems = (0, react_1.useCallback)(() => {
            ...
            try {
                ...
                const [rawFolders, rawItems] = await Promise.all([
                    ...
                    listItems.items
                        ...
                        .select('Id', 'Title', 'NavUrl', 'NavDescription', 'NavOrder', 'NavOpenInNewTab', 'FileDirRef')
                ...
                setFolders(rawFolders.map((folder) => {
                    ...
                    return ({
                        ...
                        label: folder.Title,
                        url: folder.NavUrl,
                        order: (_a = folder.NavOrder) !== null && _a !== void 0 ? _a : 0,
                ...
                setItems(rawItems.map((item) => {
                    ...
                    return ({
                        ...
                        spItemId: item.Id,
                        label: item.Title,
                        url: (_a = item.NavUrl) !== null && _a !== void 0 ? _a : '',
                        description: item.NavDescription,
                        order: (_b = item.NavOrder) !== null && _b !== void 0 ? _b : 0,
                        parentFolderPath: item.FileDirRef,
                        openInNewTab: (_c = item.NavOpenInNewTab) !== null && _c !== void 0 ? _c : false,
                    });
                }));
            }
            catch (err) {
                ...
                if (is404) {
                    ...
                    setItems([]);
                    setError(null);
                    console.warn('[TopNav] Navigationリストが見つかりません。provision-navigation-list.ps1 を実行してください。');
                }
                else {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DEFAULT_NAV_CONFIG = void 0;
exports.DEFAULT_NAV_CONFIG = {
    version: 1,
    logoSize: 40,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.hsvToRgb = exports.rgbToHsv = exports.rgbToHex = exports.hexToRgb = void 0;
/**
 * hex -> RGB
 */
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isSpNavHidden = exports.removeHideSpNav = exports.injectHideSpNav = void 0;
...
exports.injectHideSpNav = injectHideSpNav;
/**
 * Removes the injected <style> tag if it exists.
 */
function removeHideSpNav() {
    var _a;
    (_a = document.getElementById(STYLE_TAG_ID)) === null || _a === void 0 ? void 0 : _a.remove();
}
exports.removeHideSpNav = removeHideSpNav;
/**
 * Returns true if the hide style tag is currently present in the DOM.
 */
function isSpNavHidden() {
    return document.getElementById(STYLE_TAG_ID) !== null;
}
exports.isSpNavHidden = isSpNavHidden;
    ...
    if (proto) {
        if (!Reflect.has(proto, ObjExtensionsSym)) {
            Reflect.defineProperty(proto, ObjExtensionsSym, {
                value: (0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getGUID)(),
            });
        }
...
function extendCol(a, e) {
    if ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(e)) {
        a.push(...e);
    }
    else {
        a.push(e);
...
function extensionOrDefault(op, or, target, ...rest) {
    if (_enableExtensions && Reflect.has(target, ObjExtensionsSym)) {
        ...
        for (let i = 0; i < extensions.length; i++) {
            ...
            if ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.isFunc)(extension)) {
...
/* harmony export */   extendable: () => (/* reexport safe */ _extendable_js__WEBPACK_IMPORTED_MODULE_4__.extendable),
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BlobParse: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.BlobParse),
/* harmony export */   BrowserFetchWithRetry: () => (/* reexport safe */ _behaviors_browser_fetch_js__WEBPACK_IMPORTED_MODULE_6__.BrowserFetchWithRetry),
/* harmony export */   BufferParse: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.BufferParse),
/* harmony export */   CacheNever: () => (/* reexport safe */ _behaviors_caching_js__WEBPACK_IMPORTED_MODULE_7__.CacheNever),
/* harmony export */   CancelAction: () => (/* reexport safe */ _behaviors_cancelable_js__WEBPACK_IMPORTED_MODULE_9__.CancelAction),
/* harmony export */   DefaultParse: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.DefaultParse),
/* harmony export */   InjectHeaders: () => (/* reexport safe */ _behaviors_inject_headers_js__WEBPACK_IMPORTED_MODULE_10__.InjectHeaders),
/* harmony export */   JSONParse: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.JSONParse),
/* harmony export */   Queryable: () => (/* reexport safe */ _queryable_js__WEBPACK_IMPORTED_MODULE_3__.Queryable),
/* harmony export */   RejectOnError: () => (/* reexport safe */ _behaviors_resolvers_js__WEBPACK_IMPORTED_MODULE_12__.RejectOnError),
/* harmony export */   ResolveOnData: () => (/* reexport safe */ _behaviors_resolvers_js__WEBPACK_IMPORTED_MODULE_12__.ResolveOnData),
/* harmony export */   TextParse: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.TextParse),
/* harmony export */   addProp: () => (/* reexport safe */ _add_prop_js__WEBPACK_IMPORTED_MODULE_0__.addProp),
/* harmony export */   body: () => (/* reexport safe */ _request_builders_js__WEBPACK_IMPORTED_MODULE_5__.body),
/* harmony export */   cancelableScope: () => (/* reexport safe */ _behaviors_cancelable_js__WEBPACK_IMPORTED_MODULE_9__.cancelableScope),
/* harmony export */   del: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.del),
/* harmony export */   get: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.get),
/* harmony export */   headers: () => (/* reexport safe */ _request_builders_js__WEBPACK_IMPORTED_MODULE_5__.headers),
/* harmony export */   op: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.op),
/* harmony export */   parseBinderWithErrorCheck: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.parseBinderWithErrorCheck),
/* harmony export */   parseODataJSON: () => (/* reexport safe */ _behaviors_parsers_js__WEBPACK_IMPORTED_MODULE_11__.parseODataJSON),
/* harmony export */   patch: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.patch),
...
function invokable(invokeableAction) {
    if (!(0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.isFunc)(invokeableAction)) {
        invokeableAction = function (init) {
            return (0,_operations_js__WEBPACK_IMPORTED_MODULE_1__.op)(this, _operations_js__WEBPACK_IMPORTED_MODULE_1__.get, init);
        };
    }
    return (target) => {
        return new Proxy(target, {
...
Queryable = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.extendable)(),
    (0,_invokable_js__WEBPACK_IMPORTED_MODULE_1__.invokable)()
], Queryable);
...
_fi_js__WEBPACK_IMPORTED_MODULE_4__.SPFI.prototype.batched = function (props) {
    const batched = (0,_fi_js__WEBPACK_IMPORTED_MODULE_4__.spfi)(this);
...
_webs_types_js__WEBPACK_IMPORTED_MODULE_5__._Web.prototype.batched = function (props) {
    const batched = (0,_webs_types_js__WEBPACK_IMPORTED_MODULE_5__.Web)(this);
...
function createBatch(base, props) {
    ...
    const execute = async () => {
        ...
        batchBody.push(`--batch_${batchId}--\n`);
        const responses = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_2__.spPost)(batchQuery, {
            body: batchBody.join(""),
            headers: {
        ...
        instance.on.pre(async function (url, init, result) {
            ...
            this.on.auth(async (url, init) => {
                ...
                if (!(0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.objectDefinedNotNull)(digest)) {
                    digest = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)((0,_spqueryable_js__WEBPACK_IMPORTED_MODULE_3__.SPQueryable)([this, (0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.combine)(webUrl, "_api/contextinfo")]).using((0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.JSONParse)(), (0,_batching_js__WEBPACK_IMPORTED_MODULE_5__.BatchNever)()), {
                        headers: {
                            "Accept": "application/json",
                            "X-PnPjs-NoDigest": "1",
                        },
...
function Telemetry() {
    return (instance) => {
        instance.on.pre(async function (url, init, result) {
            let clientTag = "PnPCoreJS:3.26.0:";
...
_spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPQueryable.prototype.getContextInfo = async function (path = this.parentUrl) {
    const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_1__.spPost)((0,_spqueryable_js__WEBPACK_IMPORTED_MODULE_2__.SPQueryable)([this, (0,_utils_extract_web_url_js__WEBPACK_IMPORTED_MODULE_3__.extractWebUrl)(path)], "_api/contextinfo"));
...
let _Files = class _Files extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPCollection {
    ...
    getByUrl(name) {
        ...
        return File(this).concat(`('${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(name)}')`);
    }
    /**
    ...
    async addUsingPath(url, content, parameters = { Overwrite: false }) {
        const path = [`AddUsingPath(decodedurl='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(url)}'`];
        if (parameters) {
            ...
            if (!(0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.stringIsNullOrEmpty)(parameters.XorHash)) {
                path.push(`,XorHash=${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(parameters.XorHash)}`);
            }
        }
        path.push(")");
        const resp = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Files(this, path.join("")), { body: content });
        return {
            data: resp,
    ...
    async addChunked(url, content, progress, shouldOverWrite = true, chunkSize = 10485760) {
        const response = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Files(this, `add(overwrite=${shouldOverWrite},url='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(url)}')`));
    ...
    async addTemplateFile(fileUrl, templateFileType) {
        const response = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Files(this, `addTemplateFile(urloffile='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(fileUrl)}',templatefiletype=${templateFileType})`));
        return {
            data: response,
...
_Files = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_12__.defaultPath)("files")
], _Files);
 ...
 *
 */
class _File extends _readable_file_js__WEBPACK_IMPORTED_MODULE_8__.ReadableFile {
    constructor() {
        super(...arguments);
    ...
    async getLockedByUser() {
        const u = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spGet)(File(this, "lockedByUser"));
     ...
     */
    approve(comment = "") {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `approve(comment='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(comment)}')`));
    }
    /**
    ...
    cancelUpload(uploadId) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `cancelUpload(uploadId=guid'${uploadId}')`));
    }
    /**
    ...
    checkin(comment = "", checkinType = CheckinType.Major) {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `checkin(comment='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(comment)}',checkintype=${checkinType})`));
    }
    /**
     * Checks out the file from a document library.
     */
    checkout() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, "checkout"));
    }
    /**
    ...
    copyTo(url, shouldOverWrite = true) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `copyTo(strnewurl='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(url)}',boverwrite=${shouldOverWrite})`));
    }
    ...
    deny(comment = "") {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `deny(comment='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(comment)}')`));
    }
    ...
    publish(comment = "") {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `publish(comment='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(comment)}')`));
    }
    /**
     ...
     */
    recycle() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, "recycle"));
    }
    /**
    ...
    async deleteWithParams(parameters) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, "DeleteWithParameters"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.body)({ parameters }));
    }
    /**
     ...
     */
    undoCheckout() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, "undoCheckout"));
    }
    /**
    ...
    unpublish(comment = "") {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `unpublish(comment='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(comment)}')`));
    }
    /**
    ...
    async setContent(content) {
        await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, "$value"), {
            body: content,
            headers: {
                "X-HTTP-Method": "PUT",
            },
    ...
    async setContentChunked(file, progress, chunkSize = 10485760) {
        if (!(0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.isFunc)(progress)) {
            progress = () => null;
        }
    ...
    async startUpload(uploadId, fragment) {
        let n = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `startUpload(uploadId=guid'${uploadId}')`), { body: fragment });
        if (typeof n === "object") {
    ...
    async continueUpload(uploadId, fileOffset, fragment) {
        let n = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `continueUpload(uploadId=guid'${uploadId}',fileOffset=${fileOffset})`), { body: fragment });
        if (typeof n === "object") {
            // When OData=verbose the payload has the following shape:
    ...
    async finishUpload(uploadId, fileOffset, fragment) {
        const response = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(File(this, `finishUpload(uploadId=guid'${uploadId}',fileOffset=${fileOffset})`), { body: fragment });
        return {
            data: response,
            file: fileFromServerRelativePath(this, response.ServerRelativeUrl),
        };
    ...
    moveCopyImpl(destUrl, options, overwrite, methodName) {
        ...
        poster.on.pre((0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.noInherit)(async (url, init, result) => {
            const { ServerRelativeUrl: srcUrl, ["odata.id"]: absoluteUrl } = await File(this).using((0,_batching_js__WEBPACK_IMPORTED_MODULE_10__.BatchNever)()).select("ServerRelativeUrl")();
            const webBaseUrl = new URL((0,_utils_extract_web_url_js__WEBPACK_IMPORTED_MODULE_6__.extractWebUrl)(absoluteUrl));
            ...
            init = (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.body)({
                destPath: (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_13__.toResourcePath)((0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.isUrlAbsolute)(destUrl) ? destUrl : `${webBaseUrl.protocol}//${webBaseUrl.host}${destUrl}`),
                options,
                srcPath: (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_13__.toResourcePath)((0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.isUrlAbsolute)(srcUrl) ? srcUrl : `${webBaseUrl.protocol}//${webBaseUrl.host}${srcUrl}`),
            }, init);
            return [url, init, result];
        }));
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(poster).then(() => fileFromPath(this, destUrl));
    }
}
(0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    _pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.cancelableScope
...
function fileFromServerRelativePath(base, serverRelativePath) {
    return File([base, (0,_utils_extract_web_url_js__WEBPACK_IMPORTED_MODULE_6__.extractWebUrl)(base.toUrl())], `_api/web/getFileByServerRelativePath(decodedUrl='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(serverRelativePath)}')`);
}
/**
...
async function fileFromAbsolutePath(base, absoluteFilePath) {
    const { WebFullUrl } = await File(base).using((0,_batching_js__WEBPACK_IMPORTED_MODULE_10__.BatchNever)()).getContextInfo(absoluteFilePath);
...
let _Versions = class _Versions extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPCollection {
     ...
     */
    deleteAll() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Versions(this, "deleteAll"));
    }
    /**
    ...
    deleteById(versionId) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Versions(this, `deleteById(vid=${versionId})`));
    }
    /**
    ...
    recycleByID(versionId) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Versions(this, `recycleByID(vid=${versionId})`));
    }
    /**
     ...
     */
    deleteByLabel(label) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Versions(this, `deleteByLabel(versionlabel='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(label)}')`));
    }
    /**
    ...
    recycleByLabel(label) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Versions(this, `recycleByLabel(versionlabel='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(label)}')`));
    }
    /**
    ...
    restoreByLabel(label) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Versions(this, `restoreByLabel(versionlabel='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(label)}')`));
    }
};
_Versions = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_12__.defaultPath)("versions")
], _Versions);
 ...
 *
 */
class _Version extends _readable_file_js__WEBPACK_IMPORTED_MODULE_8__.ReadableFile {
    constructor() {
        super(...arguments);
...
let _Folders = class _Folders extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPCollection {
     ...
     */
    getByUrl(name) {
        return Folder(this).concat(`('${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(name)}')`);
    }
    /**
    ...
    async addUsingPath(serverRelativeUrl, overwrite = false) {
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Folders(this, `addUsingPath(DecodedUrl='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(serverRelativeUrl)}',overwrite=${overwrite})`));
        return {
            data,
...
_Folders = (0,tslib__WEBPACK_IMPORTED_MODULE_10__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_11__.defaultPath)("folders")
], _Folders);
...
class _Folder extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPInstance {
     ...
     */
    async update(props) {
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPostMerge)(this, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)(props));
        return {
            data,
            folder: this,
        };
     ...
     */
    recycle() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Folder(this, "recycle"));
    }
    /**
     * Gets the associated list item for this folder, loading the default properties
     */
     ...
     */
    async deleteWithParams(parameters) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Folder(this, "DeleteWithParameters"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({ parameters }));
    }
    /**
    ...
    async addSubFolderUsingPath(leafPath) {
        await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Folder(this, "AddSubFolderUsingPath"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({ leafPath: (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_12__.toResourcePath)(leafPath) }));
    ...
    moveCopyImpl(destUrl, options, methodName) {
        ...
        poster.on.pre((0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.noInherit)(async (url, init, result) => {
            const urlInfo = await Folder(this).using((0,_batching_js__WEBPACK_IMPORTED_MODULE_9__.BatchNever)()).getParentInfos();
            ...
            init = (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({
                destPath: (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_12__.toResourcePath)((0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.isUrlAbsolute)(destUrl) ? destUrl : (0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.combine)(uri.origin, destUrl)),
                options,
                srcPath: (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_12__.toResourcePath)((0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.combine)(uri.origin, urlInfo.Folder.ServerRelativeUrl)),
            }, init);
            return [url, init, result];
        }));
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(poster).then(() => folderFromPath(this, destUrl));
    }
}
...
function folderFromServerRelativePath(base, serverRelativePath) {
    return Folder([base, (0,_utils_extract_web_url_js__WEBPACK_IMPORTED_MODULE_6__.extractWebUrl)(base.toUrl())], `_api/web/getFolderByServerRelativePath(decodedUrl='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_7__.encodePath)(serverRelativePath)}')`);
}
/**
...
async function folderFromAbsolutePath(base, absoluteFolderPath) {
    const { WebFullUrl } = await Folder(base).using((0,_batching_js__WEBPACK_IMPORTED_MODULE_9__.BatchNever)()).getContextInfo(absoluteFolderPath);
...
/* harmony export */   PageType: () => (/* reexport safe */ _types_js__WEBPACK_IMPORTED_MODULE_4__.PageType),
/* harmony export */   PrincipalSource: () => (/* reexport safe */ _types_js__WEBPACK_IMPORTED_MODULE_4__.PrincipalSource),
/* harmony export */   PrincipalType: () => (/* reexport safe */ _types_js__WEBPACK_IMPORTED_MODULE_4__.PrincipalType),
...
/* harmony export */   SPFI: () => (/* reexport safe */ _fi_js__WEBPACK_IMPORTED_MODULE_3__.SPFI),
...
/* harmony export */   emptyGuid: () => (/* reexport safe */ _types_js__WEBPACK_IMPORTED_MODULE_4__.emptyGuid),
...
/* harmony export */   spDelete: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spDelete),
/* harmony export */   spGet: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spGet),
/* harmony export */   spInvokableFactory: () => (/* reexport safe */ _spqueryable_js__WEBPACK_IMPORTED_MODULE_0__.spInvokableFactory),
/* harmony export */   spPatch: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spPatch),
/* harmony export */   spPost: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spPost),
/* harmony export */   spPostDelete: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spPostDelete),
/* harmony export */   spPostDeleteETag: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spPostDeleteETag),
/* harmony export */   spPostMerge: () => (/* reexport safe */ _operations_js__WEBPACK_IMPORTED_MODULE_2__.spPostMerge),
/* harmony export */   spfi: () => (/* reexport safe */ _fi_js__WEBPACK_IMPORTED_MODULE_3__.spfi),
...
/* harmony export */   PagedItemCollection: () => (/* binding */ PagedItemCollection),
...
let _Items = class _Items extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_0__._SPCollection {
    ...
    */
    ...
    async add(properties = {}) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(this, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_4__.body)(properties)).then((data) => ({
            data: data,
            item: this.getById(data.Id),
        }));
    }
};
_Items = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_7__.defaultPath)("items")
], _Items);
...
class _Item extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_0__._SPInstance {
    ...
    async update(properties, eTag = "*") {
        ...
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Item(this).using(ItemUpdatedParser()), postBody);
        return {
            data,
            item: this,
        };
     ...
     */
    recycle() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Item(this, "recycle"));
    }
    /**
     ...
     */
    async deleteWithParams(parameters) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Item(this, "DeleteWithParameters"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_4__.body)({ parameters }));
    }
    /**
    ...
    async getWopiFrameUrl(action = 0) {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(i);
    }
    /**
    ...
    validateUpdateListItem(formValues, bNewDocumentUpdate = false) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(Item(this, "validateupdatelistitem"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_4__.body)({ formValues, bNewDocumentUpdate }));
    }
    /**
    ...
    async setImageField(fieldName, imageName, imageContent) {
        ...
        const result = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_5__.spPost)(q, { body: imageContent });
        const itemInfo = {
            "type": "thumbnail",
...
_ItemVersions = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_7__.defaultPath)("versions")
], _ItemVersions);
...
function PagedItemParser(parent) {
    return (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_4__.parseBinderWithErrorCheck)(async (r) => {
        ...
        const nextUrl = (0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.hOP)(json, "d") && (0,_pnp_core__WEBPACK_IMPORTED_MODULE_1__.hOP)(json.d, "__next") ? json.d.__next : json["odata.nextLink"];
        return new PagedItemCollection(parent, nextUrl, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_4__.parseODataJSON)(json));
    });
}
...
let _Lists = class _Lists extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPCollection {
     ...
     */
    getByTitle(title) {
        return List(this, `getByTitle('${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_5__.encodePath)(title)}')`);
    }
    /**
    ...
    async add(title, desc = "", template = 100, enableContentTypes = false, additionalSettings = {}) {
        ...
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(this, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)(addSettings));
    ...
    async ensureSiteAssetsLibrary() {
        const json = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(Lists(this, "ensuresiteassetslibrary"));
    ...
    async ensureSitePagesLibrary() {
        const json = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(Lists(this, "ensuresitepageslibrary"));
        return List([this, (0,_utils_odata_url_from_js__WEBPACK_IMPORTED_MODULE_3__.odataUrlFrom)(json)]);
    }
};
_Lists = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_7__.defaultPath)("lists")
], _Lists);
...
class _List extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_2__._SPInstance {
     ...
     */
    async update(properties, eTag = "*") {
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPostMerge)(this, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)(properties, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.headers)({ "IF-Match": eTag })));
        const list = (0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.hOP)(properties, "Title") ? this.getParent(List, `getByTitle('${properties.Title}')`) : List(this);
        return {
            data,
            list,
        };
     ...
     */
    getChanges(query) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, "getchanges"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({ query }));
    }
    /**
    ...
    getItemsByCAMLQuery(query, ...expands) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, "getitems").expand(...expands), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({ query }));
    }
    /**
    ...
    getListItemChangesSinceToken(query) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, "getlistitemchangessincetoken").using((0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.TextParse)()), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({ query }));
    }
    /**
     * Moves the list to the Recycle Bin and returns the identifier of the new Recycle Bin item.
     */
    async recycle() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, "recycle"));
    }
    /**
    ...
    async renderListData(viewXml) {
        ...
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(q);
    ...
    renderListDataAsStream(parameters, overrideParameters = null, query = new Map()) {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(clone, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)(params));
    }
    /**
    ...
    async renderListFormData(itemId, formId, mode) {
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, `renderlistformdata(itemid=${itemId}, formid='${formId}', mode='${mode}')`));
    ...
    async reserveListItemId() {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, "reservelistitemid"));
    }
    /**
    ...
    async addValidateUpdateItemUsingPath(formValues, decodedUrl, bNewDocumentUpdate = false, checkInComment, additionalProps) {
        const addProps = {
            FolderPath: (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_8__.toResourcePath)(decodedUrl),
        };
        if ((0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.objectDefinedNotNull)(additionalProps)) {
            if (additionalProps.leafName) {
                addProps.LeafName = (0,_utils_to_resource_path_js__WEBPACK_IMPORTED_MODULE_8__.toResourcePath)(additionalProps.leafName);
            }
            if (additionalProps.objectType) {
                addProps.UnderlyingObjectType = additionalProps.objectType;
            }
        }
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_4__.spPost)(List(this, "AddValidateUpdateItemUsingPath()"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.body)({
            bNewDocumentUpdate,
            checkInComment,
            formValues,
...
const spPost = (o, init) => (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.op)(o, _pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.post, init);
...
const spDelete = (o, init) => (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.op)(o, _pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.del, init);
const spPatch = (o, init) => (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.op)(o, _pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.patch, init);
...
class _SPQueryable extends _pnp_queryable__WEBPACK_IMPORTED_MODULE_1__.Queryable {
    ...
    constructor(base, path) {
        if (typeof base === "string") {
            ...
            if ((0,_pnp_core__WEBPACK_IMPORTED_MODULE_0__.objectDefinedNotNull)(target)) {
...
function deleteable() {
    return function () {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_2__.spPostDelete)(this);
    };
}
function deleteableWithETag() {
    return function (eTag = "*") {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_2__.spPostDeleteETag)(this, {}, eTag);
    };
}
...
let _Webs = class _Webs extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_1__._SPCollection {
    ...
    async add(Title, Url, Description = "", WebTemplate = "STS", Language = 1033, UseSamePermissionsAsParentSite = true) {
        ...
        const data = await (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPost)(Webs(this, "add"), postBody);
        return {
            data,
            web: Web([this, (0,_utils_odata_url_from_js__WEBPACK_IMPORTED_MODULE_2__.odataUrlFrom)(data).replace(/_api\/web\/?/i, "")]),
        };
    }
};
_Webs = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_8__.defaultPath)("webs")
], _Webs);
...
let _Web = class _Web extends _spqueryable_js__WEBPACK_IMPORTED_MODULE_1__._SPInstance {
    ...
    async update(properties) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPostMerge)(this, (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.body)(properties));
    }
    /**
    ...
    applyTheme(colorPaletteUrl, fontSchemeUrl, backgroundImageUrl, shareGenerated) {
        ...
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPost)(Web(this, "applytheme"), postBody);
    }
    /**
    ...
    applyWebTemplate(template) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPost)(Web(this, `applywebtemplate(webTemplate='${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_6__.encodePath)(template)}')`));
    }
    /**
     * Returns the collection of changes from the change log that have occurred within the list, based on the specified query
     *
     ...
     */
    getChanges(query) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPost)(Web(this, "getchanges"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.body)({ query }));
    }
    /**
    ...
    setStorageEntity(key, value, description = "", comments = "") {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPost)(Web(this, "setStorageEntity"), (0,_pnp_queryable__WEBPACK_IMPORTED_MODULE_0__.body)({
            comments,
            description,
            key,
            value,
    ...
    removeStorageEntity(key) {
        return (0,_operations_js__WEBPACK_IMPORTED_MODULE_3__.spPost)(Web(this, `removeStorageEntity('${(0,_utils_encode_path_str_js__WEBPACK_IMPORTED_MODULE_6__.encodePath)(key)}')`));
    }
    /**
...
_Web = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_decorators_js__WEBPACK_IMPORTED_MODULE_8__.defaultPath)("_api/web")
], _Web);
